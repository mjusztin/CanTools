...
static const CRGB COLOR_PARKED  = CRGB(LED_COLOR_PARKED_HSV); // pale, calm blueish white, see LedController.h
static const CRGB COLOR_NEUTRAL = CRGB(CHSV(160, 180, 140)); // in-between
static const CRGB COLOR_DRIVE   = CRGB(CHSV(160, 220, 200)); // deep, saturated blue
